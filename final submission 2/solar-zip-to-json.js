/**
 * ZIP to JSON Structure Converter - SolarPowerMeter Edition
 * 
...
const ID_PREFIX = 'solarpowermeter-';

/**
 * @typedef {Object} FileNode
 * @property {string} id - Unique identifier prefixed with "solarpowermeter-"
 ...
 * @param {string} [zipPath] - Optional path to ZIP file (defaults to SolarPowerMeter.zip)
 */
async function main(zipPath) {
    const targetZip = zipPath || path.join(process.cwd(), 'SolarPowerMeter.zip');
